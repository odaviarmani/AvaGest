        ...
        <Accordion type="multiple" className="w-full space-y-2">
            ...
            <AccordionItem value="m02">
                ...
                <AccordionContent className="space-y-2">
                    <MissionCheckbox id="m02_part1" label="Etapa 1 (10 pts)" checked={missions.m02_map_reveal.part1} onCheckedChange={(checked) => updateMissionStep('m02_map_reveal', 'part1', checked)} />
                    <MissionCheckbox id="m02_part2" label="Etapa 2 (10 pts)" checked={missions.m02_map_reveal.part2} onCheckedChange={(checked) => updateMissionStep('m02_map_reveal', 'part2', checked)} />
                    <MissionCheckbox id="m02_part3" label="Etapa 3 (10 pts)" checked={missions.m02_map_reveal.part3} onCheckedChange={(checked) => updateMissionStep('m02_map_reveal', 'part3', checked)} />
                </AccordionContent>
            </AccordionItem>
             ...
             <AccordionItem value="m03">
                ...
                <AccordionContent className="space-y-2">
                    ...
                    <MissionCheckbox id="m03_gold" label="Etapa 2 (10 pts)" checked={missions.m03_mine_shaft_explorer.gold_retrieved} onCheckedChange={(checked) => updateMissionStep('m03_mine_shaft_explorer', 'gold_retrieved', checked)} />
                </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="m04">
                ...
                <AccordionContent className="space-y-2">
                    <MissionCheckbox id="m04_retrieved" label="Etapa 1 (30 pts)" checked={missions.m04_careful_retrieval.retrieved} onCheckedChange={(checked) => updateMissionStep('m04_careful_retrieval', 'retrieved', checked)} />
                    <MissionCheckbox id="m04_not_broken" label="Etapa 2 (10 pts)" checked={missions.m04_careful_retrieval.not_broken} onCheckedChange={(checked) => updateMissionStep('m04_careful_retrieval', 'not_broken', checked)} />
                </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="m06">
                ...
                <AccordionContent className="space-y-2">
                    <MissionCheckbox id="m06_part1" label="Etapa 1 (10 pts)" checked={missions.m06_forge.part1} onCheckedChange={(checked) => updateMissionStep('m06_forge', 'part1', checked)} />
                    <MissionCheckbox id="m06_part2" label="Etapa 2 (10 pts)" checked={missions.m06_forge.part2} onCheckedChange={(checked) => updateMissionStep('m06_forge', 'part2', checked)} />
                    <MissionCheckbox id="m06_part3" label="Etapa 3 (10 pts)" checked={missions.m06_forge.part3} onCheckedChange={(checked) => updateMissionStep('m06_forge', 'part3', checked)} />
                </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="m08">
                ...
                <AccordionContent className="space-y-2">
                    <MissionCheckbox id="m08_part1" label="Etapa 1 (10 pts)" checked={missions.m08_silo.part1} onCheckedChange={(checked) => updateMissionStep('m08_silo', 'part1', checked)} />
                    <MissionCheckbox id="m08_part2" label="Etapa 2 (10 pts)" checked={missions.m08_silo.part2} onCheckedChange={(checked) => updateMissionStep('m08_silo', 'part2', checked)} />
                    <MissionCheckbox id="m08_part3" label="Etapa 3 (10 pts)" checked={missions.m08_silo.part3} onCheckedChange={(checked) => updateMissionStep('m08_silo', 'part3', checked)} />
                </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="m09">
                ...
                <AccordionContent className="space-y-2">
                    <MissionCheckbox id="m09_open" label="Etapa 1 (20 pts)" checked={missions.m09_whats_on_sale.store_open} onCheckedChange={(checked) => updateMissionStep('m09_whats_on_sale', 'store_open', checked)} />
                    <MissionCheckbox id="m09_pedestal" label="Etapa 2 (10 pts)" checked={missions.m09_whats_on_sale.item_on_pedestal} onCheckedChange={(checked) => updateMissionStep('m09_whats_on_sale', 'item_on_pedestal', checked)} />
                </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="m10">
                ...
                <AccordionContent className="space-y-2">
                    <MissionCheckbox id="m10_tipped" label="Etapa 1 (20 pts)" checked={missions.m10_tip_the_scales.tipped} onCheckedChange={(checked) => updateMissionStep('m10_tip_the_scales', 'tipped', checked)} />
                    <MissionCheckbox id="m10_both_down" label="Etapa 2 (10 pts)" checked={missions.m10_tip_the_scales.both_sides_down} onCheckedChange={(checked) => updateMissionStep('m10_tip_the_scales', 'both_sides_down', checked)} />
                </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="m11">
                ...
                <AccordionContent className="space-y-2">
                    <MissionCheckbox id="m11_retrieved" label="Etapa 1 (20 pts)" checked={missions.m11_fisher_artifacts.retrieved} onCheckedChange={(checked) => updateMissionStep('m11_fisher_artifacts', 'retrieved', checked)} />
                    <MissionCheckbox id="m11_pedestal" label="Etapa 2 (10 pts)" checked={missions.m11_fisher_artifacts.on_pedestal} onCheckedChange={(checked) => updateMissionStep('m11_fisher_artifacts', 'on_pedestal', checked)} />
                </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="m12">
                ...
                <AccordionContent className="space-y-2">
                    <MissionCheckbox id="m12_raised" label="Etapa 1 (20 pts)" checked={missions.m12_salvage_operation.raised} onCheckedChange={(checked) => updateMissionStep('m12_salvage_operation', 'raised', checked)} />
